        ...
        <div class="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{asset('assets/images/carousel-item1.png')}}" alt="carousel-item1.png">
        ...
        <div class="container">
            ...
            <div class="list-news">
                <nav class="list-news-content box d-flex flex-column">
                    @foreach($list_post_by_categoryID as $post)
                        <div class="item-news row">
                            ...
                            <div class="box-content ">
                                ...
                                <p class="p-content">{{$post->excerpt}}</p>
                            </div>
                        </div>
                    @endforeach
                </nav>
                {{$list_post_by_categoryID->links()}}
            </div>
        </div>
    </div>
    <footer id="footer">
