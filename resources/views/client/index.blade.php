<x-layout.client>
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="news">
                <div class="headding d-flex justify-content-center ">
                    <a href="#">
                        <img class="icon-news" src="{{asset('assets/images/icons/icon-news.png')}}" alt="icon-news.png">
                    </a>
                        ...
                        <div class="box-content">
                            ...
                            <ul>
                                ...
                                <li><span class="dot"><svg width="3" height="4" viewBox="0 0 3 4" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
                                <circle cx="1.5" cy="1.56641" r="1.5" fill="#3B4144"/></svg>
                            </span></li>
                                <li><p>Quang Anh Trần</p></li>
                                <li><span class="dot"><svg width="3" height="3" viewBox="0 0 3 4" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
                                <circle cx="1.5" cy="1.56641" r="1.5" fill="#3B4144"/></svg>
                            </span></li>
            ...
            <div class="video">
                <div class="d-flex justify-content-between">
                    <p class="p-headding">Video</p>
                    <a class="a-view_all" href="#">Xem tất cả</a>
                </div>
                <div class="video-content row">
                    ...
                    <div class="sub-video row col-sm-12 col-md-sub-video box">
                        <div class="sub-video-item col-md-12">
                            <div class="box-top">
                            ...
                            <div class="box-content">
                                <p class="p-title">Making a Housing Wage: Where Restaurant should l...</p>
                                <ul>
            ...
            <div class="list-news">
                <div>
                    <p class="p-headding">Danh sách tin</p>
                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="box-content box-content2 col-12">
                                <div class="d-none d-md-block">
                                    <p class="p-title">Making a Housing Wage: Where Teachers, First Responders and
                                ...
                                <p class="p-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit diam
                                    at
                                    feugiat purus, int et scelerisque nullam lo velit id vitae...</p>
                            </div>
                        </div>
                    </div>
                    <div class="item-news-item flex-column">
