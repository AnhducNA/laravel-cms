...
Array.from(document.getElementsByClassName('--jb-modal')).forEach(function (el) {
    el.addEventListener('click', function (e) {
        ...
        const confirmForm = document.getElementsByClassName('confirm-form');
        ...
        // Confirm delete
        Array.from(deleteModal.getElementsByClassName('button-confirm-delete')).forEach(function (el2){
